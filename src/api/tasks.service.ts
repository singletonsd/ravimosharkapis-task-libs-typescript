...
export class TasksService implements TasksServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getTasks(skip?: number, limit?: number, orderBy?: string, filterBy?: string, deleted?: Deleted, metadata?: boolean, refClient?: string, finished?: Finished, technicianId?: number, dateFixFrom?: string, dateCallUntil?: string, dateCallFrom?: string, dateFixUntil?: string, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2001>;
    ...
    public getTasks(skip?: number, limit?: number, orderBy?: string, filterBy?: string, deleted?: Deleted, metadata?: boolean, refClient?: string, finished?: Finished, technicianId?: number, dateFixFrom?: string, dateCallUntil?: string, dateCallFrom?: string, dateFixUntil?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
